    ...
    return (
        <>
            ...
            {mediaDetail != undefined &&
                <div>
                    <MediaContainer>
                        {mediaDetail.tipo === 'Vídeo' || mediaDetail.tipo === 'GIF' ? (
                            <ReactPlayer
                                url={mediaDetail.link_arquivo}
                            />
                        ) : (
                            <Image
                                width={500}
                                height={500}
                                src={mediaDetail.link_arquivo} alt={mediaDetail.titulo}
                    ...
                    {mediaDetail.tipo === 'Vídeo' &&
                        <MediaLink href={mediaDetail.link_arquivo} target="_blank" rel="noopener noreferrer">
                            Abrir no navegador
                        </MediaLink>
                    }
                </div>
