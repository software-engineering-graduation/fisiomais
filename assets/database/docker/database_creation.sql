...
CREATE TABLE
    IF NOT EXISTS `fisiomais_db`.`paciente` (
...
CREATE TABLE
    IF NOT EXISTS `fisiomais_db`.`fisioterapeuta` (
        `create_time` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
        `_id` INT NOT NULL AUTO_INCREMENT,
        `nome` VARCHAR(100) NOT NULL,
        `email` VARCHAR(255) NOT NULL,
...
CREATE TABLE
    IF NOT EXISTS `fisiomais_db`.`consulta` (
        `create_time` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
        `_id` INT NOT NULL AUTO_INCREMENT,
        ...
        CONSTRAINT `fk_consulta_paciente` FOREIGN KEY (`paciente__id`) REFERENCES `fisiomais_db`.`paciente` (`_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
        CONSTRAINT `fk_consulta_fisioterapeuta1` FOREIGN KEY (`fisioterapeuta__id`) REFERENCES `fisiomais_db`.`fisioterapeuta` (`_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
    ) ENGINE = InnoDB;
...
CREATE TABLE
    IF NOT EXISTS `fisiomais_db`.`midia` (
        `create_time` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
        `_id` INT NOT NULL AUTO_INCREMENT,
        `fisioterapeuta__id` INT NOT NULL,
        ...
        CONSTRAINT `fk_midia_fisioterapeuta1` FOREIGN KEY (`fisioterapeuta__id`) REFERENCES `fisiomais_db`.`fisioterapeuta` (`_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
    ) ENGINE = InnoDB;
...
CREATE TABLE
    IF NOT EXISTS `fisiomais_db`.`tratamento` (
        `create_time` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
        `_id` INT NOT NULL AUTO_INCREMENT,
        `fisioterapeuta__id` INT NOT NULL,
        `paciente__id` INT NOT NULL,
        ...
        CONSTRAINT `fk_tratamento_fisioterapeuta1` FOREIGN KEY (`fisioterapeuta__id`) REFERENCES `fisiomais_db`.`fisioterapeuta` (`_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
        CONSTRAINT `fk_tratamento_paciente1` FOREIGN KEY (`paciente__id`) REFERENCES `fisiomais_db`.`paciente` (`_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
    ) ENGINE = InnoDB;
...
CREATE TABLE
    IF NOT EXISTS `fisiomais_db`.`exercicio` (
        `create_time` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
        `_id` INT NOT NULL AUTO_INCREMENT,
        ...
        CONSTRAINT `fk_exercicio_fisioterapeuta1` FOREIGN KEY (`fisioterapeuta__id`) REFERENCES `fisiomais_db`.`fisioterapeuta` (`_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
    ) ENGINE = InnoDB;
...
CREATE TABLE
    IF NOT EXISTS `fisiomais_db`.`tratamento_has_exercicios` (
        ...
        CONSTRAINT `fk_tratamento_has_exercicios_tratamento10` FOREIGN KEY (`tratamento__id`) REFERENCES `fisiomais_db`.`tratamento` (`_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
        CONSTRAINT `fk_tratamento_has_exercicios_exercicio10` FOREIGN KEY (`exercicio__id`) REFERENCES `fisiomais_db`.`exercicio` (`_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
    ) ENGINE = InnoDB;
...
CREATE TABLE
    IF NOT EXISTS `fisiomais_db`.`agenda` (
        `_id` INT NOT NULL AUTO_INCREMENT,
        `create_time` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
        ...
        CONSTRAINT `fk_agenda_fisioterapeuta1` FOREIGN KEY (`fisioterapeuta__id`) REFERENCES `fisiomais_db`.`fisioterapeuta` (`_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
    ) ENGINE = InnoDB;
